...
with tab1:
    st.markdown("<h3 style='text-align: center; color: white;'>Frequencia de Incêndios por Ano</h3>",
...
with tab2:
   st.markdown("<h3 style='text-align: center; color: white;'>Frequencia de Incêndios por Mês</h3>",
            unsafe_allow_html=True)
