...
with tab1:
    ...
    st.bar_chart(df, x="ano" , y="PRECIPITACAO", color="rgb(255, 75, 75)", stack='layered')
...
with tab2:
   ...
   st.bar_chart(df_selection, x="mes_numero" , y="PRECIPITACAO", color="rgb(255, 75, 75)", stack='layered')
